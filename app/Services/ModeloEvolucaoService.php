...
Após avaliação social, o(a) paciente {{paciente}} foi encaminhado(a) para {{local_origem}}, considerando a necessidade de acompanhamento pela rede de apoio {{rede_apoio}}. Relata como principal fonte de renda {{fonte_renda}} e reside com {{com_quem_reside}}. Encontra-se {{estado_paciente}} e foi orientado(a) quanto ao serviço de destino, documentação e procedimentos. Serviço Social permanece à disposição.
    ...
    'visita_domiciliar' => "
Realizada visita domiciliar ao(à) paciente {{paciente}} em {{data}}, com objetivo de averiguar condições sociais e ambientais. Foi recepcionado(a) por {{pronome_acomp}} {{acompanhante}} ({{parentesco}}), que relatou {{estado_paciente}} do(a) paciente. Domicílio compartilhado com {{com_quem_reside}}, apresenta como fonte de renda {{fonte_renda}} e rede de apoio {{rede_apoio}}. Orientações foram prestadas quanto à continuidade do cuidado e garantia de direitos.
    ",

    'internacao_psiquiatrica' => "
O(a) paciente {{paciente}} foi admitido(a) em {{local_origem}} após intercorrência de saúde mental relacionada a {{motivo_internacao}}. Durante atendimento, encontrava-se {{estado_paciente}}, acompanhado(a) de {{pronome_acomp}} {{acompanhante}} ({{parentesco}}). Reside com {{com_quem_reside}} e apresenta como rede de apoio {{rede_apoio}}. Foi orientado(a) quanto aos direitos e acompanhamento pelo CAPS após alta.
    ",

    'avaliacao_socioeconomica' => "
Paciente {{paciente}}, residente com {{com_quem_reside}}, possui como principal fonte de renda {{fonte_renda}}. Encontra-se {{estado_paciente}} e relata como rede de apoio {{rede_apoio}}. Compareceu acompanhado(a) de {{pronome_acomp}} {{acompanhante}} ({{parentesco}}), sendo acolhido(a) pelo Serviço Social em {{data}}. Avaliação realizada com vistas à elaboração de parecer e apoio institucional.
    ",
...
Acolhimento realizado com a usuária {{paciente}}, acompanhada de {{pronome_acomp}} {{acompanhante}}, {{parentesco}}. Gestação: {{gestacao}}, parto {{tipo_parto}}, com nascimento de RN do sexo {{sexo_rn}}. Reside com {{com_quem_reside}}. Renda familiar proveniente de {{fonte_renda}}. Foram repassadas orientações referentes a direitos sociais, bem como sobre normas e rotinas institucionais. O Serviço Social segue acompanhando a usuária e permanece à disposição.
    ",

    'avaliacao_leito' => "
O(a) paciente {{paciente}} visitado(a) em leito para acompanhamento social, acompanhado(a) por {{pronome_acomp}} {{parentesco}} {{acompanhante}}. Relata contar com {{rede_apoio}}, residir em imóvel {{tipo_imovel}} e possuir fonte de renda {{estabilidade_renda}}, proveniente de {{fonte_renda}}. Durante a internação, está sendo acompanhado(a) por {{rede_acompanhantes}}. O Serviço Social segue acompanhando {{paciente}} e permanece à disposição.
    ",
];
